...
- (nonnull UIView *)createSplashScreenView
{
  ...
  @try {
    ...
    ABI39_0_0UMLogInfo(@"'SplashScreen.storyboard' file is missing. Fallbacking to 'SplashScreen.xib' file.");
  }
  if (storyboard) {
    @try {
  ...
  @try {
    ...
    ABI39_0_0UMLogInfo(@"'SplashScreen.xib' file is missing - 'expo-splash-screen' would not work as expected.");
  }
  if (views) {
