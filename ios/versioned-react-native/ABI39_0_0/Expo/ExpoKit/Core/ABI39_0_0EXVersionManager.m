...
{
  ABI39_0_0RCTDevSettings *devSettings = [self _moduleInstanceForBridge:bridge named:@"DevSettings"];
...
- (id<ABI39_0_0RCTBridgeModule>)_moduleInstanceForBridge:(id)bridge named:(NSString *)name
{
  ...
  ABI39_0_0RCTModuleData *data = [bridge moduleDataForName:name];
  if (data) {
                        ...
                        logThreshold:(NSInteger)threshold
{
  ...
  ABI39_0_0RCTSetLogThreshold(threshold);
...
- (NSArray *)extraModulesWithParams:(NSDictionary *)params
{
  ...
  NSMutableArray *extraModules = [NSMutableArray arrayWithArray:
                                  @[
                                    ...
                                    [[ABI39_0_0EXDevSettings alloc] initWithExperienceId:experienceId isDevelopment:(!isOpeningHomeInProductionMode && isDeveloper)],
  ...
  if (exceptionsManagerDelegate) {
    ABI39_0_0RCTExceptionsManager *exceptionsManager = [[ABI39_0_0RCTExceptionsManager alloc] initWithDelegate:exceptionsManagerDelegate];
  ...
  if ([params[@"isStandardDevMenuAllowed"] boolValue] && isDeveloper) {
    [extraModules addObject:[[ABI39_0_0RCTDevMenu alloc] init]];
  } else {
    // non-kernel, or non-development kernel, uses expo menu instead of ABI39_0_0RCTDevMenu
    [extraModules addObject:[[ABI39_0_0EXDisabledDevMenu alloc] init]];
  }
  if (!isDeveloper) {
    // user-facing (not debugging).
    // additionally disable ABI39_0_0RCTRedBox
    [extraModules addObject:[[ABI39_0_0EXDisabledRedBox alloc] init]];
  }
  ...
  id<ABI39_0_0UMFileSystemInterface> fileSystemModule = [moduleRegistry getModuleImplementingProtocol:@protocol(ABI39_0_0UMFileSystemInterface)];
  NSString *localStorageDirectory = [fileSystemModule.documentDirectory stringByAppendingPathComponent:@"RCTAsyncLocalStorage"];
  [extraModules addObject:[[ABI39_0_0RCTAsyncLocalStorage alloc] initWithStorageDirectory:localStorageDirectory]];
