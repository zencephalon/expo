...
{
    id touchEvent = [[ABI39_0_0RNGestureHandlerEvent alloc] initWithRactTag:ABI39_0_0ReactTag
                                                        handlerTag:_tag
                                                             state:state
                                                         extraData:extraData];

    if (state != _lastState) {
        if (state == ABI39_0_0RNGestureHandlerStateEnd && _lastState != ABI39_0_0RNGestureHandlerStateActive) {
            [self.emitter sendStateChangeEvent:[[ABI39_0_0RNGestureHandlerStateChange alloc] initWithRactTag:ABI39_0_0ReactTag
                                                                                         handlerTag:_tag
        ...
        id stateEvent = [[ABI39_0_0RNGestureHandlerStateChange alloc] initWithRactTag:ABI39_0_0ReactTag
                                                                  handlerTag:_tag
                                                                       state:state
                                                                   prevState:_lastState
                                                                   extraData:extraData];
