...
- (ABI39_0_0UMModuleRegistry *)moduleRegistryForParams:(NSDictionary *)params forExperienceId:(NSString *)experienceId withKernelServices:(NSDictionary *)kernelServices
{
  ...
  ABI39_0_0EXUpdatesBinding *updatesBinding = [[ABI39_0_0EXUpdatesBinding alloc] init];
  ...
  ABI39_0_0EXScopedFileSystemModule *fileSystemModule = [[ABI39_0_0EXScopedFileSystemModule alloc] initWithExperienceId:experienceId andConstantsBinding:constantsBinding];
