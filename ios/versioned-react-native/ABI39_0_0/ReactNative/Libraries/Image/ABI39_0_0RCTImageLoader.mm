...
@interface ABI39_0_0RCTImageLoader() <NativeImageLoaderIOSSpec, ABI39_0_0RCTImageLoaderWithAttributionProtocol>
...
- (id<ABI39_0_0RCTImageDataDecoder>)imageDataDecoderForData:(NSData *)data
{
  ...
  if (!_decoders) {
    ...
    _decoders = [[_bridge modulesConformingToProtocol:@protocol(ABI39_0_0RCTImageDataDecoder)] sortedArrayUsingComparator:^NSComparisonResult(id<ABI39_0_0RCTImageDataDecoder> a, id<ABI39_0_0RCTImageDataDecoder> b) {
