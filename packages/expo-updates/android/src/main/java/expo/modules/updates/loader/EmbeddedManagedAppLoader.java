...
public class EmbeddedManagedAppLoader {

  private static final String TAG = EmbeddedManagedAppLoader.class.getSimpleName();
  ...
  public EmbeddedManagedAppLoader(Context context, UpdatesDatabase database, File updatesDirectory) {
    mContext = context;
    mDatabase = database;
    mUpdatesDirectory = updatesDirectory;
  }

  public boolean loadEmbeddedUpdate(Manifest manifest) {
