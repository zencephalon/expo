 ...
 *
 */
export declare type TransitionProperty = 'none' | 'all' | string;
export declare type TransitionTimingFunction = string | 'linear' | 'ease' | 'ease-in' | 'ease-out' | 'ease-in-out' | 'step-start' | 'step-end';
